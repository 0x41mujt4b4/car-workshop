              ...
              >
                <td className="p-2 md:p-2">
                  <div className="flex flex-row">
                    ...
                    <button className="text-blue-400 hover:text-white border border-blue-400 rounded hover:bg-blue-400 mx-1 text-xs p-[2px]">
                      تعديل <EditOutlinedIcon sx={{ fontSize: 14 }} />
                      {/* <i className="text-base">
                </i> */}
                    </button>
                    <button className="text-slate-700 hover:text-white border border-slate-700 rounded hover:bg-slate-700 text-xs p-[2px]">
